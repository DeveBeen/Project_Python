...
name=['청포도에이드', '무알콜맥주', '카페라떼', '카푸치노', '헤이즐넛아메리카노', '헤이즐넛라떼', '헤이즐넛카푸치노', '바닐라라떼', '카페모카', '화이트초코모카', '민트초코우유', '생수', '생수', '레쓰비', '레쓰비', '봉봉', '갈아먹는배', '코코팜', '아이스티', '식혜']
cost = [1500, 2500, 1200, 1400, 1200, 1400, 1600, 1500, 2000, 2100, 3400, 300, 300, 700, 700, 900, 1300, 1000, 1000, 800]
num = [1,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15]
